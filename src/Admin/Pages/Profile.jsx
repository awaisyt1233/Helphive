...
export default function Profile() {
  ...
  return (
    <div className="p-4 max-w-5xl mx-auto space-y-8">
      ...
      {/* Account Statistics */}
      <div className="bg-white shadow p-6 rounded-lg space-y-4 mt-6">
        <h2 className="text-lg font-bold text-gray-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 bg-gray-50 rounded-lg">
            ...
            <p className="text-gray-800 mt-1">Administrator</p>
          </div>

          <div className="p-4 bg-gray-50 rounded-lg">
            <p className="text-gray-600 text-sm">Complaints Resolved</p>
            <p className="text-blue-800 mt-1">124</p>
          </div>

          <div className="p-4 bg-gray-50 rounded-lg">
            <p className="text-gray-600 text-sm">Resolution Success Rate</p>
            <p className="text-green-600 mt-1">92%</p>
          </div>
        </div>
      </div>
    </div>
